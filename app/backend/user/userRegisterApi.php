...
$result_user_table = $conn->query("INSERT INTO user (fname,lname,dob,phone_num,email,add_1,add_2,add_3,lat,lon,gnd) values('$fname','$lname','$dob','$phone_num','$email','$add1','$add2','$add3','$lat','$lon','$gnd_id')");
